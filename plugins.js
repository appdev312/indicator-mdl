// All plugins supported by Nimbus.
//
//  Required parameters per plugin.
//
// name: Name of the plugin
// slug: name of the plugin mapped to the config key. Expected
//    filename to exist in `nimbus/plugins/` (only if path is not
//    specified)
// async: upon creating a new plugin instance, does something async
//    happen where Nimbus needs to wait for? If set to true, the
//    constructor will be passed a callback which it should execute
//    as soon as Nimbus can continue.
// modes: a list indicating in what Nimbus modes this plugin is
...
// path: fn that returns path of file of the plugin (overwrites `nimbus/plugins/{slug}`)
//    when given the configuration object (relative from `nimbus/plugins/`).
var plugins = [
  {
    name: 'Candle writer',
  ...
  {
    name: 'IRC bot',
    description: 'IRC module lets you communicate with Nimbus on IRC.',
    slug: 'ircbot',
    async: false,
    modes: ['realtime'],
    dependencies: [{
  ...
  {
    name: 'Telegram bot',
    description: 'Telegram module lets you communicate with Nimbus on Telegram.',
    slug: 'telegrambot',
    async: false,
    modes: ['realtime'],
    dependencies: [{
  ...
  {
    name: 'XMPP bot',
    description: 'XMPP module lets you communicate with Nimbus on Jabber.',
    slug: 'xmppbot',
    async: false,
    silent: false,
    modes: ['realtime'],
  ...
  {
    name: 'Campfire bot',
    description: 'Lets you communicate with Nimbus on Campfire.',
    slug: 'campfire',
    async: false,
    modes: ['realtime'],
    dependencies: [{
  ...
  {
    name: 'Mailer',
    description: 'Sends you an email everytime Nimbus has new advice.',
    slug: 'mailer',
    async: true,
    modes: ['realtime'],
    dependencies: [{
  ...
  },
  {
    ...
    async: false,
    modes: ['realtime', 'backtest'],
    emits: ['paperPortfolioUpdate', 'paperTrade'],
  ...
  {
    name: 'Paper Performance Analyzer',
    description: 'Analyzes performances of trades for backtest',
    slug: 'paperPerformanceAnalyzer',
    async: false,
    modes: ['realtime', 'backtest'],
    path: config => 'paperPerformanceAnalyzer/paperPerformanceAnalyzer.js',
  },
  {
    name: 'Redis beacon',
    slug: 'redisBeacon',
