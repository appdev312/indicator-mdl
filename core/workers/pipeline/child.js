/*
  ...
  Nimbus is a Bitcoin trading bot for popular Bitcoin exchanges written 
  in node, it features multiple trading methods using technical analysis.

  If you are interested in how Nimbus works, read more about Nimbus's 
  architecture here:
...
var start = (mode, config) => {
  ...
  // force correct nimbus env
  util.setGekkoEnv('child-process');

  var dirs = util.dirs();

  // force correct nimbus mode & config
